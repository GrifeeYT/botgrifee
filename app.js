console.log('')
console.log('-------------------------------')
console.log('  Скрипт Bot Gridee запущен.')
console.log('  Разработчик: Максим Емельянов')
console.log('  vk.com/grifee_yt')
...
const businesses = [
	{
		name: 'Шаурмичная Shaverma House',
		cost: 50000,
		earn: 400,
		id: 1,
		icon: '🥖'
...
bot(`Привет! Что бы узнать мои команды напиши «Помощь». 📚

Беседа с ботом :https://vk.me/join/AJQ1dyFOIRdnQ7M2txkl5Fv6 `, 
		{
...
💼 Бизнес:
⠀⠀📈 Бизнес - посмотреть статистику бизнеса
⠀⠀💵 Бизнес снять
⠀⠀⚒️ Бизнес улучшить
...
cmd.hear(/^(?:помощь)\s(.*)$/i, async (message, bot) => {
	...
	{
		return message.send(`Владея бизнесом, вы можете зарабатывать немало колличество денег:
...
cmd.hear(/^(?:донат)$/i, async (message, bot) => {
	return bot(`узнать список товаров и купить донат в автоматическом режиме можно на нашем сайте: https://www.donationalerts.com/r/✅`);
});
...
${message.user.transport.car === 18 ? '🔹' : '🔸'} 18. BMW M5 F 90 (4.500.000$)
...
${message.user.misc.phone === 4 ? '🔹' : '🔸'} 4. BQ Aquaris X (5.000$)
${message.user.misc.phone === 5 ? '🔹' : '🔸'} 5. Sony Xperia XA (7.000$)
${message.user.misc.phone === 6 ? '🔹' : '🔸'} 6. Samsung Galaxy S8 (10.000$)
${message.user.misc.phone === 7 ? '🔹' : '🔸'} 7. Xiaomi Mi 8 (17.000$)
${message.user.misc.phone === 8 ? '🔹' : '🔸'} 8. Xiaomi Mi 9 (24.000$)
${message.user.misc.phone === 9 ? '🔹' : '🔸'} 9. iPhone X (100.000$)
${message.user.misc.phone === 10 ? '🔹' : '🔸'} 10. Xiaomi Mi 10T (26.000$)
${message.user.misc.phone === 11 ? '🔹' : '🔸'} 11. iPhone 11 (55.000$)
${message.user.misc.phone === 12 ? '🔹' : '🔸'} 12. iPhone 12 (80.000$)
${message.user.misc.phone === 13 ? '🔹' : '🔸'} 13. iPhone 13 Pro Max (158.000$)
${message.user.misc.phone === 14 ? '🔹' : '🔸'} 14.  Black Shark 5 (42.000$)
${message.user.misc.phone === 15 ? '🔹' : '🔸'} 15. Poco X3 Pro (28.000$)
...
${message.user.misc.farm === 1 ? '🔹' : '🔸'} 1. 6U Nvidia 2₿/час (20.500$)
${message.user.misc.farm === 2 ? '🔹' : '🔸'} 2. AntminerS9 10₿/час (50.000$)
${message.user.misc.farm === 3 ? '🔹' : '🔸'} 3. FM2018-BT200 100₿/час (90.000$)
...
Для покупки введите "Фермы [номер] [кол-во]"`);
	...
	if(message.user.balance < 20500) return bot(`недостаточно денег ${smileerror}`);
	else if(message.user.balance >= 20500)
	{

		var pricefarms1 = 20500*message.args[1];
...
Для покупки введите "Фермы [номер] [кол-во]"`);
	...
	if(message.user.balance < 50000) return bot(`недостаточно денег ${smileerror}`);
	else if(message.user.balance >= 50000)
	{

		var pricefarms2 = 50000*message.args[1];
...
Для покупки введите "Фермы [номер] [кол-во]"`);
	...
	if(message.user.balance < 90000) return bot(`недостаточно денег ${smileerror}`);
	else if(message.user.balance >= 90000)
	{

		var pricefarms3 = 90000*message.args[1];
...
cmd.hear(/^(?:рейтинг)\s(.*)$/i, async (message, bot) => {
	...
	if(( message.args[1] * 25000 ) > message.user.balance) return bot(`у вас недостаточно денег`);
	else if(( message.args[1] * 25000 ) <= message.user.balance)
	{
		message.user.balance -= ( message.args[1] * 25000 );
...
${message.user.business === 1 ? '🔸' : '🔹'} 1. Шаурмичная Shaverma House - 50.000$
⠀ ⠀ ⠀ Прибыль: 400$/час
${message.user.business === 2 ? '🔸' : '🔹'} 2. Ларёк - 70.000$
⠀ ⠀ ⠀ Прибыль: 700$/час
${message.user.business === 3 ? '🔸' : '🔹'} 3. Ресторан - 300.000$
⠀ ⠀ ⠀ Прибыль: 2.500$/час
${message.user.business === 4 ? '🔸' : '🔹'} 4. Магазин FixPrice - 500.000$
⠀ ⠀ ⠀ Прибыль: 3.800$/час
${message.user.business === 5 ? '🔸' : '🔹'} 5. Завод - 1.000.000$
⠀ ⠀ ⠀ Прибыль: 8.000$/час
${message.user.business === 6 ? '🔸' : '🔹'} 6. «ООО» Майнинг - 2.000.000$
⠀ ⠀ ⠀ Прибыль: 70.000$/час
${message.user.business === 7 ? '🔸' : '🔹'} 7. Офис Ростелеком - 4.000.000$
⠀ ⠀ ⠀ Прибыль: 220.000$/час
${message.user.business === 8 ? '🔸' : '🔹'} 8. Разработка игр - 7.000.000$
⠀ ⠀ ⠀ Прибыль: 300.000$/час
${message.user.business === 9 ? '🔸' : '🔹'} 9. Нефтевышка - 10.000.000$
⠀ ⠀ ⠀ Прибыль: 500.000$/час
${message.user.business === 10 ? '🔸' : '🔹'} 10. Атомная электростанция - 20.000.000$
⠀ ⠀ ⠀ Прибыль: 700.000$/час
${message.user.business === 11 ? '🔸' : '🔹'} 11. NASA - 100.000.000$
...
cmd.hear(/^(?:бонус|🔑 Бонус|@destinybot 🔑 Бонус)$/i, async (message, bot) => {
	...
	if(prize === 2)
	{
		...
		return bot(`вы выиграли 100₿ ${smilesuccess}`);
	}
	...
	if(prize === 9)
	{
		message.user.bank += 35000;
		return bot(`вы выиграли 35.000$ на свой банковский счёт ${smilesuccess}`);
	}
	if(prize === 10)
	{
	...
	if(prize === 11)
	{
		message.user.bank += 12345;
		return bot(`вы выиграли 12.345$ на свой банковский счёт ${smilesuccess}`);
	}

	if(prize === 12)
	{
		message.user.bank += 993;
		return bot(`вы выиграли 1.000 - 7$ на свой банковский счёт ${smilesuccess}`);
	}
});
...
cmd.hear(/^(?:поход)$/i, async (message, bot) => {
	...
	{
		message.user.btc += 100;
		return bot(`находясь в походе, вы нашли 100₿ ${smilesuccess}`);
	}
...
cmd.hear(/^(?:работа)$/i, async (message, bot) => {
	...
	🔹 1. Дворник - зарплата ~1.250$
	🔹 2. Сварщик - зарплата ~2.800$
	🔹 3. Электрик - зарплата ~4.000$
	🔹 4. Охранник в FixPrixe - зарплата ~5.250$
	🔹 5. Адвокат - зарплата ~6.750$
	🔹 6. Бухгалтер - зарплата ~8.500$
	🔹 7. Бармен в Пивбаре - зарплата ~11.250$
	🔹 8. Администратор в кафе - зарплата ~13.000$
	🔹 9. Дизайнен - зарплата ~17.000$
...
cmd.hear(/^(?:работать)$/i, async (message, bot) => {
	...
	⏳ Вы сможете работать в ближайший 1 час`);
...
cmd.hear(/^(?:кубик|куб)\s([1-6])$/i, async (message, bot) => {
	...
	if(int == message.args[1])
	{
		...
		return bot(`вы угадали! Приз 5.000$`);
...
taxicash = utils.random(13923, 21811);
message.user.energy -= 1;
...
let hackcash = utils.random(1561,2158);
...
let hackcash = utils.random(2601,3185);
message.user.balance += hackcash;
setTimeout(() => {
	message.user.timers.hack = false;
}, 300000);
